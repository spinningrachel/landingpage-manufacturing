  ...
  return (
    ...
    >
      <_Builtin.Block
        ...
        fs-cc="banner"
      >
        <_Builtin.Block className="fs-cc-banner2_container" tag="div">
          <_Builtin.Block className="fs-cc-banner2_text" tag="div">
            {
          ...
          <_Builtin.Block className="fs-cc-banner2_buttons-wrapper" tag="div">
            <_Builtin.Link
      ...
      <_Builtin.Block
        className="fs-cc-manager2_component"
        tag="div"
        fs-cc="manager"
      >
        <_Builtin.HtmlEmbed
          className="fs-cc-manager2_button"
          role="button"
          tabIndex="0"
      ...
      <_Builtin.Block
        className="fs-cc-prefs2_component"
        tag="div"
        fs-cc="preferences"
        fs-cc-scroll="disable"
      >
        <_Builtin.FormWrapper className="fs-cc-prefs2_form-wrapper">
          <_Builtin.FormForm
          ...
          >
            <_Builtin.Block
              className="fs-cc-prefs2_close"
              tag="div"
              fs-cc="close"
            >
              <_Builtin.HtmlEmbed
                className="fs-cc-preferences2_close-icon"
            ...
            <_Builtin.Block className="fs-cc-prefs2_content" tag="div">
              <_Builtin.Block className="fs-cc-prefs2_space-small" tag="div">
                <_Builtin.Block className="fs-cc-prefs2_title" tag="div">
                  {"Privacy Preferences"}
                </_Builtin.Block>
              </_Builtin.Block>
              <_Builtin.Block className="fs-cc-prefs2_option" tag="div">
                <_Builtin.Block
                  className="fs-cc-prefs2_toggle-wrapper"
                  tag="div"
                >
                  <_Builtin.Block className="fs-cc-prefs2_label" tag="div">
                    {"Essential cookies"}
                  </_Builtin.Block>
              ...
              <_Builtin.Block className="fs-cc-prefs2_option" tag="div">
                ...
                >
                  ...
                  <_Builtin.FormCheckboxWrapper className="fs-cc-prefs2_checkbox-field">
                    <_Builtin.FormCheckboxInput
                      className="fs-cc-prefs2_checkbox"
                      type="checkbox"
                      name="marketing-2"
                    ...
                    <_Builtin.FormInlineLabel
                      className="fs-cc-prefs2_checkbox-label"
                      htmlFor="marketing-3"
                    >
                      {"Essential"}
                    </_Builtin.FormInlineLabel>
              ...
              <_Builtin.Block
                className="fs-cc-prefs2_buttons-wrapper"
                tag="div"
              >
                <_Builtin.Link
                  className="fs-cc-prefs2_button fs-cc-button-alt"
                  button={true}
                  fs-cc="deny"
                  block=""
                  options={{
          ...
          <_Builtin.Block
            className="fs-cc-prefs2_overlay"
            tag="div"
            fs-cc="close"
          />
