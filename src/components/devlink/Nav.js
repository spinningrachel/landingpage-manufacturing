...
export function Nav({
  ...
  return (
    <_Component className="nav" tag="nav">
      <_Builtin.Block className="nav_banner is-gradient" tag="div">
        <_Builtin.Block className="container is-nav" tag="div">
          <_Builtin.Block className="nav_banner-layout" tag="div">
      ...
      <_Builtin.Block className="nav_block" tag="div">
        <_Builtin.Block className="container is-nav" tag="div">
          <_Builtin.HtmlEmbed
            className="is-display-hidden"
          ...
          />
          <_Builtin.Block className="nav_layout" tag="div">
            <_Builtin.Link
            ...
            <_Builtin.List className="nav_menu-list" tag="ul" unstyled={true}>
              <_Builtin.ListItem className="nav_menu-list-item is-mobile-top">
                <_Builtin.Link
                  className="nav_logo-link"
                  button={false}
                  aria-label="back to home"
                ...
                <_Builtin.Block className="nav_mobile-burger" tag="div" />
              </_Builtin.ListItem>
              <_Builtin.ListItem className="nav_menu-list-item is-second-top">
                ...
                >
                  ...
                  <_Builtin.DropdownList
                    className="nav_dropdown-list is-mm"
                    tag="nav"
                  >
                    <_Builtin.Block
                      className="nav_menu-mobile_mm-block"
                      tag="div"
                    >
                      <_Builtin.Block
                        className="nav_menu-mobile_mm-wrapper"
                        tag="div"
                      >
                        <_Builtin.Block className="is-mm-caption" tag="div">
                          {"key features"}
                        </_Builtin.Block>
                    ...
                    >
                      <_Builtin.TabsMenu className="nav_mm-tabs-menu" tag="div">
                        ...
                        >
                          <_Builtin.Block
                            className="nav_mm_title-block"
                            tag="div"
                          >
                            <_Builtin.Block
                              className="is-body-m is-text-purple"
                              tag="div"
                            >
                              {"Key Features"}
                            </_Builtin.Block>
                          ...
                          <_Builtin.Block
                            className="txt-wrapper is-display-hidden"
                            tag="div"
                          >
                      ...
                      >
                        ...
                        >
                          <_Builtin.Block
                            className="nav_mm_title-block is-pane"
                            tag="div"
                          >
                            <_Builtin.Block
                              className="is-body-m is-text-purple"
                            ...
                            <_Builtin.Block
                              className="txt-wrapper is-mm-pane"
                              tag="div"
                            >
                              <_Builtin.Block className="is-body-xs" tag="div">
                                {
              ...
              <_Builtin.ListItem className="nav_menu-list-item">
              ...
              <_Builtin.ListItem className="nav_menu-list-item">
                ...
                >
                  ...
                  <_Builtin.DropdownList
                    className="nav_dropdown-list"
                    tag="nav"
                  >
                    <_Builtin.DropdownLink
                      className="nav_link is-dropdown is-mobile-underline"
                      options={{
                        href: "#",
                      }}
                    >
                    ...
                    <_Builtin.DropdownLink
                      className="nav_link is-dropdown"
                      options={{
                        href: "#",
                      }}
                    >
              ...
              <_Builtin.ListItem className="nav_menu-list-item is-display-hidden-tablet">
              ...
              <_Builtin.ListItem className="nav_menu-list-item is-mobile-no-underline">
                <_Builtin.DropdownWrapper
                  className="nav_dropdown"
                  tag="div"
                  delay={0}
              ...
              <_Builtin.ListItem className="nav_menu-list-item is-ctas">
                <_Builtin.Block
                  className="nav_ctas-wrapper is-post-wrapper"
                  tag="div"
                >
                  {signInLinkVisibility ? (
                    <_Builtin.Link
                      className="nav_link is-sign-in"
                      button={false}
                      target="_blank"
                      block=""
                      options={{
                  ...
                  {getADemoVisibility ? (
                    <_Builtin.Link
                      className="button-secondary-small is-mobile-big hide"
                  ...
                  {startForFreeVisibility ? (
                    <_Builtin.Link
                      className="button-primary-small is-mobile-big"
                      button={true}
                      target="_blank"
            ...
            <_Builtin.Block className="nav_mobile-burger is-open" tag="div">
              <_Builtin.NotSupported _atom="Animation" />
            </_Builtin.Block>
            <_Builtin.Block className="nav_mobile-bg-hack" tag="div" />
          </_Builtin.Block>
        </_Builtin.Block>
      </_Builtin.Block>
    </_Component>
