...
import { PopUpGad } from "./PopUpGad";
import { MenuListKeyFeatures } from "./MenuListKeyFeatures";
import * as _utils from "./utils";
import _styles from "./PopUpGaq.module.css";

const _interactionsData = JSON.parse(
  '{"events":{"e-29":{"id":"e-29","name":"","animationType":"preset","eventTypeId":"MOUSE_CLICK","action":{"id":"","actionTypeId":"GENERAL_START_ACTION","config":{"delay":0,"easing":"","duration":0,"actionListId":"a-11","affectedElements":{},"playInReverse":false,"autoStopEventId":"e-30"}},"mediaQueries":["main","medium","small","tiny"],"target":{"id":"91208423-eda4-b6ce-6c14-7973a809e437","appliesTo":"ELEMENT","styleBlockIds":[]},"targets":[{"id":"91208423-eda4-b6ce-6c14-7973a809e437","appliesTo":"ELEMENT","styleBlockIds":[]}],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":null,"scrollOffsetUnit":null,"delay":null,"direction":null,"effectIn":null},"createdOn":1718689592108},"e-31":{"id":"e-31","name":"","animationType":"custom","eventTypeId":"MOUSE_CLICK","action":{"id":"","actionTypeId":"GENERAL_START_ACTION","config":{"delay":0,"easing":"","duration":0,"actionListId":"a-10","affectedElements":{},"playInReverse":false,"autoStopEventId":"e-32"}},"mediaQueries":["main","medium","small","tiny"],"target":{"id":"d1a7c648-1859-578d-d1ee-5cd5d73d0d3b","appliesTo":"ELEMENT","styleBlockIds":[]},"targets":[{"id":"d1a7c648-1859-578d-d1ee-5cd5d73d0d3b","appliesTo":"ELEMENT","styleBlockIds":[]}],"config":{"loop":false,"playInReverse":false,"scrollOffsetValue":null,"scrollOffsetUnit":null,"delay":null,"direction":null,"effectIn":null},"createdOn":1718689686558}},"actionLists":{"a-11":{"id":"a-11","title":"Popup GAQ [Close]","actionItemGroups":[{"actionItems":[{"id":"a-11-n","actionTypeId":"GENERAL_DISPLAY","config":{"delay":0,"easing":"","duration":0,"target":{"selector":".popop-gaq_component","selectorGuids":["d5ab7f2f-c74c-ec84-0352-a2c72927ae59"]},"value":"none"}},{"id":"a-11-n-2","actionTypeId":"STYLE_OPACITY","config":{"delay":0,"easing":"","duration":100,"target":{"selector":".popup-gaq_wrapper","selectorGuids":["0323a88b-ae54-56bc-43e0-7a33319f9d5d"]},"value":0,"unit":""}}]}],"useFirstGroupAsInitialState":false,"createdOn":1718655033696},"a-10":{"id":"a-10","title":"Popup GAQ [Open]","actionItemGroups":[{"actionItems":[{"id":"a-10-n-4","actionTypeId":"STYLE_OPACITY","config":{"delay":0,"easing":"","duration":500,"target":{"selector":".popup-gaq_wrapper","selectorGuids":["0323a88b-ae54-56bc-43e0-7a33319f9d5d"]},"value":0,"unit":""}}]},{"actionItems":[{"id":"a-10-n-2","actionTypeId":"GENERAL_DISPLAY","config":{"delay":0,"easing":"","duration":0,"target":{"selector":".popop-gaq_component","selectorGuids":["d5ab7f2f-c74c-ec84-0352-a2c72927ae59"]},"value":"flex"}}]},{"actionItems":[{"id":"a-10-n-5","actionTypeId":"STYLE_OPACITY","config":{"delay":200,"easing":"","duration":100,"target":{"selector":".popup-gaq_wrapper","selectorGuids":["0323a88b-ae54-56bc-43e0-7a33319f9d5d"]},"value":1,"unit":""}}]}],"useFirstGroupAsInitialState":true,"createdOn":1718655033696}},"site":{"mediaQueries":[{"key":"main","min":992,"max":10000},{"key":"medium","min":768,"max":991},{"key":"small","min":480,"max":767},{"key":"tiny","min":0,"max":479}]}}'
);

export function PopUpGaq({ as: _Component = _Builtin.Block, popupsId }) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component
      className={_utils.cx(_styles, "popop-gaq_component")}
      tag="div"
      fs-scrolldisable-element="when-visible"
    >
      <_Builtin.Block
        className={_utils.cx(_styles, "popup-gaq_wrapper")}
        tag="div"
      >
        <_Builtin.Block className={_utils.cx(_styles, "popup_left")} tag="div">
          ...
          >
            ...
            <_Builtin.Paragraph className={_utils.cx(_styles, "is-body-l")}>
              <_Builtin.Strong>
                {
                  "Pricing based on your model, data scale and operational requirements"
                }
              </_Builtin.Strong>
            </_Builtin.Paragraph>
            <_Builtin.Block tag="div">
              <_Builtin.Paragraph
                className={_utils.cx(_styles, "is-body-xs", "is-bottom-16")}
              >
                {"Our process is designed to be focused on "}
                <_Builtin.Strong>
                  <_Builtin.Emphasized>{"your"}</_Builtin.Emphasized>
                </_Builtin.Strong>
                {" needs."}
              </_Builtin.Paragraph>
              <_Builtin.Paragraph className={_utils.cx(_styles, "is-body-xs")}>
                {"‍"}
                <_Builtin.Strong>
                  {"Tell Us About Your Project"}
                </_Builtin.Strong>{" "}
                <br />
                {"Briefly describe your use case, challenges, and goals."}
                <br />
                <br />
                {"‍"}
                <_Builtin.Strong>
                ...
                <br />
                {
                  "We'll connect to understand your environment, workflows, and success criteria."
                }
                <br />
                <br />
                {"‍"}
          ...
          <_Builtin.Block
            ...
            id={_utils.cx(
              _styles,
              "w-node-_91208423-eda4-b6ce-6c14-7973a809e40c-a809e3fa"
            )}
            tag="div"
          >
            <_Builtin.Block
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "popup_right")}
          tag="div"
          id={popupsId}
        >
          <_Builtin.HtmlEmbed
          ...
          <_Builtin.Block
            ...
            id={_utils.cx(
              _styles,
              "w-node-_91208423-eda4-b6ce-6c14-7973a809e430-a809e3fa"
            )}
            tag="div"
          >
            <_Builtin.Strong>{"Partner With Us Today"}</_Builtin.Strong>
          </_Builtin.Block>
          ...
          >
            <_Builtin.FormForm
              ...
              method="get"
              data-webflow-hubspot-api-form-url="https://hubspotonwebflow.com/api/forms/d1b7b663-a297-485c-91b5-20a769ac0054"
              id="email-form"
            >
              ...
              <_Builtin.DOM tag="label" slot="">
                ...
                />
                {
                  "<p>Yes, I agree to receive marketing emails and calls in line with Visual Layer’s privacy policy.</p>"
                }
              </_Builtin.DOM>
              <_Builtin.DOM tag="label" slot="">
                <_Builtin.DOM
        ...
        <_Builtin.Block
          className={_utils.cx(_styles, "popup-gaq_close-button")}
          id={_utils.cx(
            _styles,
            "w-node-_91208423-eda4-b6ce-6c14-7973a809e437-a809e3fa"
          )}
          data-w-id="91208423-eda4-b6ce-6c14-7973a809e437"
          tag="div"
        />
      </_Builtin.Block>
      <PopUpGad />
