...
import _styles from "./NavTabs.module.css";
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "is-body-m", "is-text-purple")}
              tag="div"
            >
              {"Key feautres"}
            </_Builtin.Block>
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "txt-wrapper")}
            tag="div"
          >
            <_Builtin.Block
      ...
      >
        ...
        >
          <_Builtin.Block
            className={_utils.cx(_styles, "nav_mm_title-block", "is-pane")}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "is-body-m", "is-text-purple")}
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "txt-wrapper", "is-mm-pane")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "is-body-xs")}
