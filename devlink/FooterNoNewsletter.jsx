...
import _styles from "./FooterNoNewsletter.module.css";

export function FooterNoNewsletter({ as: _Component = _Builtin.Block }) {
  return (
    <_Component className={_utils.cx(_styles, "footer")} tag="footer">
      <_Builtin.Block
        className={_utils.cx(_styles, "container", "is-footer")}
        tag="div"
      >
        <_Builtin.Block
          ...
          tag="div"
        >
          <NewsletterForm newsletterVisibility={true} />
          <_Builtin.Block
            className={_utils.cx(_styles, "footer_inner-grid", "is-top")}
            id={_utils.cx(
              _styles,
              "w-node-_36b6d3d5-e3be-bd39-20bb-bf63c8c5df6b-c8c5df67"
            )}
            tag="div"
          >
            <_Builtin.Link
            ...
            >
              <_Builtin.HtmlEmbed
                ...
                id={_utils.cx(
                  _styles,
                  "w-node-_36b6d3d5-e3be-bd39-20bb-bf63c8c5df6d-c8c5df67"
                )}
            ...
            <_Builtin.Block
              className={_utils.cx(_styles, "footer_menu-grid")}
              id={_utils.cx(
                _styles,
                "w-node-_36b6d3d5-e3be-bd39-20bb-bf63c8c5df6e-c8c5df67"
              )}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "footer_menu-grid-item")}
                id={_utils.cx(
                  _styles,
                  "w-node-_36b6d3d5-e3be-bd39-20bb-bf63c8c5df6f-c8c5df67"
                )}
                tag="div"
              >
                <FooterMenuTitle menuTitleText="Navigation" />
                <_Builtin.List
                  className={_utils.cx(_styles, "footer_menu-list")}
                  tag="ul"
                  unstyled={true}
                >
                  <_Builtin.ListItem
                    className={_utils.cx(_styles, "footer_menu-list-item")}
                  >
                    <FooterLink
                      linkText="Home"
                      linkUrl={{
              ...
              <_Builtin.Block
                ...
                id={_utils.cx(
                  _styles,
                  "w-node-_36b6d3d5-e3be-bd39-20bb-bf63c8c5df7f-c8c5df67"
                )}
                tag="div"
              >
            ...
            <_Builtin.Block
              ...
              id={_utils.cx(
                _styles,
                "w-node-_36b6d3d5-e3be-bd39-20bb-bf63c8c5df8f-c8c5df67"
              )}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "footer_menu-group")}
                tag="div"
              >
                <_Builtin.List
                  className={_utils.cx(
                ...
                <_Builtin.Block
                  className={_utils.cx(_styles, "footer_line")}
                  tag="div"
                />
                <_Builtin.Link
                  className={_utils.cx(_styles, "footer_link", "is-email")}
                  button={false}
                  block="inline"
                  options={{
                ...
                >
                  <_Builtin.HtmlEmbed
                    className={_utils.cx(_styles, "footer_link-icon")}
                  ...
                  <_Builtin.Block
                    ...
                    tag="div"
                  >
                    {"info@visual-layer.com"}
                  </_Builtin.Block>
                </_Builtin.Link>
              </_Builtin.Block>
            </_Builtin.Block>
            <_Builtin.Block
              className={_utils.cx(_styles, "footer_divider", "is-show-mobile")}
              tag="div"
            >
              <_Builtin.Block
          ...
          <_Builtin.Block
            className={_utils.cx(_styles, "footer_inner-grid", "is-btm")}
            id={_utils.cx(
              _styles,
              "w-node-_36b6d3d5-e3be-bd39-20bb-bf63c8c5dfaa-c8c5df67"
            )}
            tag="div"
          >
            <_Builtin.Block
              className={_utils.cx(_styles, "footer_btm-menu-wrapper")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "footer_btm-block")}
                tag="div"
              >
                ...
                <_Builtin.HtmlEmbed
                  className={_utils.cx(_styles, "footer_year-embed")}
              ...
              <_Builtin.Block
                className={_utils.cx(_styles, "footer_btm-block", "is-legal")}
                tag="div"
              >
                <FooterLinkGrey
            ...
            >
              <_Builtin.HtmlEmbed
                className={_utils.cx(_styles, "footer_line-gradient")}
        ...
        <_Builtin.Image
          className={_utils.cx(_styles, "squares", "is-footer")}
          width="790"
          height="Auto"
          loading="lazy"
          alt=""
